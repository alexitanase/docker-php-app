...
abstract class Partner implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\PropelService\\Map\\PartnerTableMap';
    ...
    /**
     * Initializes internal state of PropelService\Base\Partner object.
     * @see applyDefaults()
     */
    ...
    {
        return json_decode($this->options, $asArray);
    }
    ...
    public function setIntId($v)
    {
        ...
        if ($this->int_id !== $v) {
            $this->int_id = $v;
            $this->modifiedColumns[PartnerTableMap::COL_INT_ID] = true;
        }
    ...
    public function setCode($v)
    {
        ...
        if ($this->code !== $v) {
            $this->code = $v;
            $this->modifiedColumns[PartnerTableMap::COL_CODE] = true;
        }
    ...
    public function setLogo($v)
    {
        ...
        if ($this->logo !== $v) {
            $this->logo = $v;
            $this->modifiedColumns[PartnerTableMap::COL_LOGO] = true;
        }
    ...
    public function setStructure($v)
    {
        ...
        if ($this->structure !== $v) {
            $this->structure = $v;
            $this->modifiedColumns[PartnerTableMap::COL_STRUCTURE] = true;
        }
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[PartnerTableMap::COL_STATUS] = true;
        }
    ...
    public function setOptions($v)
    {
        ...
        if ($encodedValue !== $this->options) {
            $this->options = $encodedValue;
            $this->modifiedColumns[PartnerTableMap::COL_OPTIONS] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : PartnerTableMap::translateFieldName('IntId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->int_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : PartnerTableMap::translateFieldName('Code', TableMap::TYPE_PHPNAME, $indexType)];
            $this->code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : PartnerTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : PartnerTableMap::translateFieldName('Logo', TableMap::TYPE_PHPNAME, $indexType)];
            $this->logo = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : PartnerTableMap::translateFieldName('Structure', TableMap::TYPE_PHPNAME, $indexType)];
            $this->structure = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : PartnerTableMap::translateFieldName('Status', TableMap::TYPE_PHPNAME, $indexType)];
            $this->status = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : PartnerTableMap::translateFieldName('Options', TableMap::TYPE_PHPNAME, $indexType)];
            $this->options = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : PartnerTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : PartnerTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 9; // 9 = PartnerTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\PropelService\\Partner'), 0, $e);
        }
    }
    ...
    public function save(?ConnectionInterface $con = null): int
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(PartnerTableMap::COL_UPDATED_AT)) {
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(PartnerTableMap::COL_INT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`int_id`';
        }
        if ($this->isColumnModified(PartnerTableMap::COL_CODE)) {
            $modifiedColumns[':p' . $index++]  = '`code`';
        }
        if ($this->isColumnModified(PartnerTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(PartnerTableMap::COL_LOGO)) {
            $modifiedColumns[':p' . $index++]  = '`logo`';
        }
        if ($this->isColumnModified(PartnerTableMap::COL_STRUCTURE)) {
            $modifiedColumns[':p' . $index++]  = '`structure`';
        }
        if ($this->isColumnModified(PartnerTableMap::COL_STATUS)) {
            $modifiedColumns[':p' . $index++]  = '`status`';
        }
        if ($this->isColumnModified(PartnerTableMap::COL_OPTIONS)) {
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(PartnerTableMap::COL_INT_ID)) {
            $criteria->add(PartnerTableMap::COL_INT_ID, $this->int_id);
        }
        if ($this->isColumnModified(PartnerTableMap::COL_CODE)) {
            $criteria->add(PartnerTableMap::COL_CODE, $this->code);
        }
        if ($this->isColumnModified(PartnerTableMap::COL_NAME)) {
            $criteria->add(PartnerTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(PartnerTableMap::COL_LOGO)) {
            $criteria->add(PartnerTableMap::COL_LOGO, $this->logo);
        }
        if ($this->isColumnModified(PartnerTableMap::COL_STRUCTURE)) {
            $criteria->add(PartnerTableMap::COL_STRUCTURE, $this->structure);
        }
        if ($this->isColumnModified(PartnerTableMap::COL_STATUS)) {
            $criteria->add(PartnerTableMap::COL_STATUS, $this->status);
        }
        if ($this->isColumnModified(PartnerTableMap::COL_OPTIONS)) {
            $criteria->add(PartnerTableMap::COL_OPTIONS, $this->options);
        }
        if ($this->isColumnModified(PartnerTableMap::COL_CREATED_AT)) {
     ...
     * objects.
     *
     * @param object $copyObj An object of \PropelService\Partner (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \PropelService\Partner Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
