...
<head>
    ...
    <!--end::Layout Skins -->
    <link rel="apple-touch-icon" href="/assets/media/logos/redlineicona_Tavola_disegno_1.png" sizes="512x512">
    <link rel="icon" href="/assets/media/logos/redlineicona_Tavola_disegno_1.png" sizes="512x512" type="image/png">
</head>
...
<div class="kt-grid kt-grid--ver kt-grid--root">
    <div class="kt-grid__item kt-grid__item--fluid kt-grid  kt-error-v1" style="background-image: url(/assets/media/error/bg1.jpg);">
        <div class="kt-error-v1__container">
            ...
            <h3 class="kt-error-v1__number">404</h3>
