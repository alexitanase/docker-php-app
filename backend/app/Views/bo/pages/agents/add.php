        ...
        <div class="kt-subheader__main">
            ...
            <div class="kt-subheader__group" id="kt_subheader_search">
                <span class="kt-subheader__desc" id="kt_subheader_total">
                    Enter agent details and submit
                </span>
            </div>
        </div>
            ...
            <div class="kt-grid  kt-wizard-v1 kt-wizard-v1--white" id="kt_projects_add" data-ktwizard-state="step-first">
                ...
                <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v1__wrapper">
                    ...
                    <form class="kt-form" method="post" enctype="multipart/form-data" id="kt_projects_add_form">
                        <input type="hidden" name="opType" value="1011" />

                        <!--begin: Form Wizard Step 1-->
                        <div class="kt-wizard-v1__content" data-ktwizard-type="step-content" data-ktwizard-state="current">
                            <div class="kt-heading kt-heading--md">Agent Details:</div>
                                            ...
                                            <div class="kt-section__body">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9 col-xl-9">
                                                        <input name="agentFullname" class="form-control" type="text" value="">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label">Email <span class="text-danger font-weight-bold">*</span></label>
                                                    <div class="col-lg-9 col-xl-9">
                                                        <input name="agentEmail" class="form-control" type="email" value="">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label">Password <span class="text-danger font-weight-bold">*</span></label>
                                                    <div class="col-lg-9 col-xl-9">
                                                        <input name="agentPassword" class="form-control" type="password" value="">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label">Password Confirm <span class="text-danger font-weight-bold">*</span></label>
                                                    <div class="col-lg-9 col-xl-9">
                                                        <input name="agentPasswordConf" class="form-control" type="password" value="">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
...
<script>
    ...
    $('#kt_projects_add_form .form-control').on('keyup', function(e){
        $('.kt-wizard-v1__review-content').html('Agent email: '+$('input[name="agentEmail"]').val()+"<br />Agent type: "+$('select[name="agentType"] > option:selected').html()+"<br />Status: "+$('select[name="agentStatus"] > option:selected').html())
    });
                    ...
                    success: function(response, status, xhr, $form) {
                        ...
                        if(typeof message.resultCode !== 'undefined' && message.resultCode === 0){
                            swal.fire({
                                ...
                                window.location='<?=@$basePath?>/pag/agents/edit/'+message.responseInfo.AgentId;
                            });
                        }else{
                            swal.fire({
                                "title": "",
