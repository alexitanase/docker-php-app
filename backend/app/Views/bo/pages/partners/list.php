...
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
    <div class="kt-container  kt-container--fluid ">
        ...
        <div class="kt-subheader__toolbar">
            <a href="<?=@$basePath?>/pag/partners/add" class="btn btn-label-brand btn-bold">
                Add Partner
            </a>
        </div>
    </div>
...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
    ...
    <div class="kt-portlet kt-portlet--mobile">
        ...
        <div class="kt-portlet__body kt-portlet__body--fit">
            ...
            <!--begin: Datatable -->
            <div class="kt-datatable" id="kt_partners_list_datatable"></div>
...
<script>
    ...
    var init = function () {
        ...
        datatable = $('#kt_partners_list_datatable').KTDatatable({
            ...
            columns: [
                ...
                },
                {
                    ...
                    template: function (data, i) {
                        ...
                        output = '' +
                            ...
                            '<a href="<?=@$basePath?>/pag/partners/edit/'+data.IntId+'" class="kt-user-card-v2__name">' + data.Name + '</a>' +
                            '<span class="kt-user-card-v2__desc">Partner</span>' +
                            '</div>' +
                            '</div>';
                ...
                },
                {
                    ...
                    overflow: 'visible',
                    template: function (row) {
                        return '<a href="<?=@$basePath?>/pag/partners/edit/'+row.IntId+'" class="btn btn-sm btn-default btn-icon btn-icon-md">' +
            ...
            if (ids.length > 0) {
                ...
                swal.fire({
                    ...
                    if (result.value) {
                        ...
                        form.append('opType', 1028);
                        form.append('internalId', elements.join(','));
                        form.append('partnerStatus', dataStatus);
                        $.ajax({
                            url: '<?=@$as?>',
                            method: "POST",
                            headers: {
