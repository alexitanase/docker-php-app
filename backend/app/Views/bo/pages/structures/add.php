        ...
        <div class="kt-subheader__main">
            ...
            <div class="kt-subheader__group" id="kt_subheader_search">
                <span class="kt-subheader__desc" id="kt_subheader_total">
                    Enter structure details and submit
                </span>
            </div>
        </div>
            ...
            <div class="kt-grid  kt-wizard-v1 kt-wizard-v1--white" id="kt_projects_add" data-ktwizard-state="step-first">
                ...
                <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v1__wrapper">
                    ...
                    <form class="kt-form" method="post" enctype="multipart/form-data" id="kt_projects_add_form">
                        <input type="hidden" name="opType" value="1021" />
                        
                        <!--begin: Form Wizard Step 1-->
                        <div class="kt-wizard-v1__content" data-ktwizard-type="step-content" data-ktwizard-state="current">
                            <div class="kt-heading kt-heading--md">Structure Details:</div>
                                            ...
                                            <div class="kt-section__body">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9 col-xl-9">
                                                        <input name="structureName" class="form-control" type="text" value="">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label">Code <span class="text-danger font-weight-bold">*</span></label>
                                                    <div class="col-lg-9 col-xl-9">
                                                        <input name="structureCode" class="form-control" type="text" value="">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label">Parent <span class="text-danger font-weight-bold">*</span></label>
                                                    <div class="col-lg-9 col-xl-9">
                                                ...
                                                <div class="form-group form-group-last row">
                                                    ...
                                                    <div class="col-lg-9 col-xl-9">
                                                        <?php
                                                        $valueSet = \PropelService\Map\StructureTableMap::getValueSet(\PropelService\Map\StructureTableMap::COL_STATUS);
                                                        ?>
                                                        <select name="structureStatus" class="form-control">
                                                            <?php
...
<script>
    ...
    $('#kt_projects_add_form .form-control').on('keyup', function(e){
        $('.kt-wizard-v1__review-content').html('Structure name: '+$('input[name="structureName"]').val()+"<br />Structure code: "+$('input[name="structureCode"]').val()+"<br />Parent: "+($('select[name="structureParent"]').val() === '' ? 'OWNER' : $('select[name="structureParent"]').val())+"<br />Status: "+$('select[name="structureStatus"]').val())
    });
                    ...
                    success: function(response, status, xhr, $form) {
                        ...
                        if(typeof message.resultCode !== 'undefined' && message.resultCode === 0){
                            swal.fire({
                                ...
                                window.location='<?=@$basePath?>/pag/structures/edit/'+message.responseInfo.StructureId;
                            });
                        }else{
                            swal.fire({
                                "title": "",
