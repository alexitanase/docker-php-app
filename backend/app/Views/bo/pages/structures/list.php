...
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
    <div class="kt-container  kt-container--fluid ">
        <div class="kt-subheader__main">
            ...
            <div class="kt-subheader__group kt-hidden" id="kt_subheader_group_actions">
                ...
                <div class="btn-toolbar kt-margin-l-20">
                    ...
                    <button class="btn btn-label-success btn-bold btn-sm btn-icon-h" id="kt_subheader_group_actions_fetch" data-toggle="modal" data-target="#kt_datatable_records_fetch_modal" style="display: none;">
                        Fetch Selected
                    </button>
        ...
        <div class="kt-subheader__toolbar">
            <a href="<?=@$basePath?>/pag/structures/add" class="btn btn-label-brand btn-bold">
                Add Structure
            </a>
        </div>
    </div>
...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
    ...
    <div class="kt-portlet kt-portlet--mobile">
        ...
        <div class="kt-portlet__body kt-portlet__body--fit">
            ...
            <!--begin: Datatable -->
            <div class="kt-datatable" id="kt_structures_list_datatable"></div>
...
<script>
    ...
    var init = function () {
        ...
        datatable = $('#kt_structures_list_datatable').KTDatatable({
            ...
            data: {
                ...
                source: {
                    read: {
                        ...
                        params: {
                            opType: 1020,
                            parent: $('select[name="filterByStructure"]').val()
                        },
                        headers: {
            ...
            columns: [
                ...
                },
                {
                    ...
                    template: function (data, i) {
                        ...
                        output = '' +
                            ...
                            '<a href="<?=@$basePath?>/pag/structures/edit/'+data.IntId+'" class="kt-user-card-v2__name">' + data.Name + '</a>' +
                            '<span class="kt-user-card-v2__desc">' + data.Code + '</span>' +
                            '</div>' +
                            '</div>';
                        return output;
                    }
                },
                {
                    ...
                    template: function (row) {
                        return (row.Parent === '' ? 'OWNER' : row.Parent);
                    },
                },
                {
                    width: 110,
                ...
                },
                {
                    ...
                    overflow: 'visible',
                    template: function (row) {
                        return '<a href="<?=@$basePath?>/pag/structures/edit/'+row.IntId+'" class="btn btn-sm btn-default btn-icon btn-icon-md">' +
            ...
            if (ids.length > 0) {
                ...
                swal.fire({
                    ...
                    if (result.value) {
                        ...
                        form.append('opType', 1023);
                        form.append('internalId', elements.join(','));
                        form.append('structureStatus', dataStatus);
                        $.ajax({
                            url: '<?=@$as?>',
                            method: "POST",
                            headers: {
