...
class EditStatusStructureRequest extends AbstractLoggedRequest
{
        ...
        try{
            ...
            if(is_array($structure_id)){
                ...
                foreach ($structures as $structure){
                    ...
                    $structure->setStatus(($this->params->structureStatus == 'ENABLED' ? StructureTableMap::COL_STATUS_ENABLED : StructureTableMap::COL_STATUS_DISABLED));
                    $structure->save();
                    $structure->reload();
